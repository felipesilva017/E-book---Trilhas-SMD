import image1 from '../../../assets/interacao-humano-computador.PNG'
import image2 from '../../../assets/design-thinking.PNG'
import image3 from '../../../assets/designer.PNG'
import { BrowserBar, InnerLine, PageBadge } from '../VisualAccents'
import PageFrame from '../PageFrame'

function ContentPage06() {
  return (
    <PageFrame
      ariaLabel="Pagina de conteudo 6"
    ...
    >
      ...
      <div className="relative z-20 flex h-[calc(100%-58px)] flex-col gap-6 px-[52px] pb-[136px] pt-[58px] max-lg:px-[26px] max-lg:pb-[124px] max-lg:pt-[42px]">
        <div className="max-w-[68ch]">
          <h2 className="m-0 font-display text-[clamp(1rem,1.5vw,1.3rem)] leading-[1.06] text-[#0d120c]">
            Design Digital Interativo (A Experiência Humana)
          </h2>
        </div>
        ...
        <div className="grid gap-8 lg:grid-cols-[1.15fr_0.85fr]">
          <div className="flex flex-col gap-3 lg:pr-6">
            <p className="m-0 max-w-[46ch] text-[clamp(0.95rem,1.5vw,1.02rem)] leading-[1.6] text-[#293015] text-justify">
              A tecnologia só faz sentido quando encontra o humano. No Design Digital Interativo, o foco é a empatia e a usabilidade. Esta trilha molda como nos comunicamos com as máquinas, estudando a estética, as emoções e a ergonomia das interfaces. É exatamente aqui, entre o físico e o projetado, que nascem as instalações multimídias e as experiências que transformam o uso cotidiano em arte.
            </p>
          </div>
      ...
      <PageBadge>Pagina 6</PageBadge>
    </PageFrame>
  )
}

export default ContentPage06