...
function ContentPage07() {
  return (
    <PageFrame
      ariaLabel="Pagina de conteudo 7"
    ...
    >
      ...
      <div className="relative z-20 flex h-[calc(100%-58px)] flex-col gap-3 px-[52px] pb-[92px] pt-[58px] max-lg:px-[26px] max-lg:pb-[76px] max-lg:pt-[42px]">
        ...
        <p className="m-0 max-w-[38ch] text-[clamp(0.95rem,1.5vw,1.02rem)] leading-[1.55] text-[#293015] text-justify">
          <strong>Objetivo:</strong> Aprofundar os conhecimentos sobre as bases teóricas e práticas do Design e do desenvolvimento de tecnologias digitais interativas.
        </p>

        <p className="m-0 max-w-[38ch] text-[clamp(0.95rem,1.5vw,1.02rem)] leading-[1.55] text-[#293015] text-justify">
          <strong>Foco:</strong> Visão crítica do processo de design, suas funções (prática, estética e simbólica) e a experiência do usuário (UX).
        </p>

        <p className="m-0 max-w-[38ch] text-[clamp(0.95rem,1.5vw,1.02rem)] leading-[1.55] text-[#293015] text-justify">
          <strong>Disciplinas Chave:</strong> Design Emocional, Interação Humano-Computador, Design de Interfaces Gráficas, Computação Física e Instalações Multimídia.
        </p>
      </div>
      ...
      <PageBadge>Pagina 7</PageBadge>
    </PageFrame>
  )
}

export default ContentPage07